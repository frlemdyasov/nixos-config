...
local menu        = "wmenu-run -f  \"Public Sans Regular 12\""
...
hl.on("hyprland.start", function () 
  hl.exec_cmd("swaybg -i /etc/nixos/hyprland/TaosTrip.png")
end)
...
-- Example per-device configmiddl
-- See https://wiki.hypr.land/Configuring/Advanced-and-Cool/Devices/ for more
hl.device({
    name        = "endgame-gear-endgame-gear-xm2-8k-gaming-mouse",
    sensitivity = 0.0,
    accel_profile = "flat",
})
...
hl.bind(mainMod .. " + SHIFT + D", hl.dsp.exec_cmd(fileManager))
...
hl.bind(mainMod .. " + CTRL + ALT + SHIFT + L", hl.dsp.exec_cmd("firefox --new-tab https://www.linkedin.com/"))
...
-- Reset window sizes back to default
...
-- Screenshot Utility
hl.bind("Print", hl.dsp.exec_cmd('grim -l "9"  -g "$(slurp)" ~/Pictures/Screenshots/screenshot-`date +%Y%^Cd-%H%M%S`.png'))
